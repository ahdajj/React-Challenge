Projects can be found in seperate branches 

1-Todolist : a simple todo list app  was built with React provides the ability to add several tasks and mark finished task ,also this app provides a done filter to display only finished tasks

2-Quote-generator : a one page app , fetch a random quote using api 
